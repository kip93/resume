...
\begin{resume}
    ...
    \begin{skillset}{Languages}
        \skill{English}{5}
        \skill{Spanish}{4}
        % You can create links wherever you want.
        \skill{\link{https://lotr.fandom.com/wiki/Quenya}{Quenya}}{2}
    \end{skillset}

    % And the different skill levels have tooltips to better describe the
    % mastery (or lack thereof) of each one.
